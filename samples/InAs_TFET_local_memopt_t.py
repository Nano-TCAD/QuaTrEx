...
if __name__ == "__main__":
    ...
    solution_path = os.path.join(scratch_path, "InAs_nanowire_TFET/")
    ...
    hamiltonian_obj = OMENHamClass.Hamiltonian(args.file_hm, no_orb, Vappl = Vappl,  potential_type = 'atomic', bias_point = 0, rank = rank, layer_matrix = '/Layer_Matrix.dat')
