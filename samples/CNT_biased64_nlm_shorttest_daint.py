...
if __name__ == "__main__":
    ...
    hamiltonian_obj = OMENHamClass.Hamiltonian(args.file_hm, no_orb, Vappl = Vappl,  potential_type = 'linear', rank = rank, layer_matrix = '/Layer_Matrix.dat', homogenize = True)
    ...
    # output folder
    folder = '/users/ldeuschl/results/CNT_biased_cf_shorttest_epsR1_n64/'
