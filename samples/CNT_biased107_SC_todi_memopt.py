...
if __name__ == "__main__":
    ...
    folder = '/capstor/scratch/cscs/ldeuschl/results/restart_CNT_biased_SC_BB1_epsR1_n192/'
    for iter_num in range(max_iter):
        ...
        if(iter_num % 5) == 0:
            ...
            SE_path = '/capstor/scratch/cscs/ldeuschl/restart_results/SE_restart_CNT_biased_SC_BB1_epsR1_n192/'
