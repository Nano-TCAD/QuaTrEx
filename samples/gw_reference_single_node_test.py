...
if __name__ == "__main__":
    ...
    for gw_iteration in range(number_of_gw_iterations):
        ...
        energy_fermi_left = energy_conduction_band_minimum + energy_difference_fermi_minimum_left
        energy_fermi_right = energy_conduction_band_minimum + energy_difference_fermi_minimum_right
        ...
        # transform the polarization from flattened to list
        ...
        Screened_interaction_greater_previous_iteration_flattened = \
            ...
            + screened_interaction_memory_factor * Screened_interaction_greater_previous_iteration_flattened
        Screened_interaction_lesser_previous_iteration_flattened = \
            ...
            + screened_interaction_memory_factor * Screened_interaction_lesser_previous_iteration_flattened
