...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        allocation_time += time.perf_counter()
        print(f"    Allocation: {allocation_time:.3f} s", flush = True)

        copying_time = -time.perf_counter()
        ...
        copying_time += time.perf_counter()
        print(f"    Copying: {copying_time:.3f} s", flush = True)

        system_matrix_time = -time.perf_counter()
        ...
        system_matrix_time += time.perf_counter()
        print(f"    System matrix: {system_matrix_time:.3f} s", flush = True)

        beyn_time = -time.perf_counter()
        ...
        print(f"    Beyn: {beyn_time:.3f} s", flush = True)
        print(f"        Left: {left_beyn_time:.3f} s", flush = True)
        print(f"        Right: {right_beyn_time:.3f} s", flush = True)
        print(f"        Difference: {(beyn_time - left_beyn_time - right_beyn_time):.3f} s", flush = True)
