...
def gw2s_fft_cpu(
    ...
    sg_1 = linalg_cpu.scalarmul_ifft(sg_t_1, pre_factor, ne, no)
    sl_1 = linalg_cpu.scalarmul_ifft(sl_t_1, pre_factor, ne, no)
    sr_1 = linalg_cpu.scalarmul_ifft(sr_t_1, pre_factor, ne, no)

    sg_2 = np.flip(linalg_cpu.scalarmul_ifft(sg_t_2, pre_factor, ne, no), axis=1)
    sl_2 = np.flip(linalg_cpu.scalarmul_ifft(sl_t_2, pre_factor, ne, no), axis=1)
    sr_2 = np.flip(linalg_cpu.scalarmul_ifft(sr_t_2, pre_factor, ne, no), axis=1)
