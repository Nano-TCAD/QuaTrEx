...
def calc_W_pool(DH, E, PG, PL, PR, V, w_mask, mkl_threads=1, worker_num=1):
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=worker_num) as executor:
        ...
        executor.map(rgf_W, repeat(V), PG, PL, PR, repeat(bmax), repeat(bmin), WG_3D_E, WGnn1_3D_E, WL_3D_E, WLnn1_3D_E,
                     WR_3D_E, WRnn1_3D_E, XR_3D_E, dosw, nEw, nPw, repeat(nbc), index_e, factor)
