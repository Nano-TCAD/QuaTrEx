...
def create_matrices(n, n_blocks, sparsity=1):
    ...
    while n_temp < n * n_blocks:
        ...
        SigL00 = sparse.vstack([sparse.hstack([SigL00, SigL01]), sparse.hstack([-SigL01.T.conj(), SigL00])])
        SigL01 = sparse.vstack(
            [sparse.csr_matrix((n_temp, 2 * n_temp)),
             sparse.hstack([SigL01, sparse.csc_matrix((n_temp, n_temp))])])

        SigG00 = sparse.vstack([sparse.hstack([SigG00, SigG01]), sparse.hstack([-SigG01.T.conj(), SigG00])])
        SigG01 = sparse.vstack(
            [sparse.csr_matrix((n_temp, 2 * n_temp)),
...
def step1_GF_rs(M, SigL, SigG, grR, grL, grG, Bmin, Bmax):
    ...
    grL[-1, 0:NN,
        0:NN] = grR[-1, 0:NN, 0:NN] @ SigL[Bmin[-1]:Bmax[-1] + 1, Bmin[-1]:Bmax[-1] + 1] @ grR[-1, 0:NN, 0:NN].T.conj()
    grG[-1, 0:NN,
        0:NN] = grR[-1, 0:NN, 0:NN] @ SigG[Bmin[-1]:Bmax[-1] + 1, Bmin[-1]:Bmax[-1] + 1] @ grR[-1, 0:NN, 0:NN].T.conj()
...
def step1_GF_ls(M, SigL, SigG, glR, glL, glG, Bmin, Bmax):
    ...
    glL[0, 0:NF,
        0:NF] = glR[0, 0:NF, 0:NF] @ SigL[Bmin[0]:Bmax[0] + 1, Bmin[0]:Bmax[0] + 1] @ glR[0, 0:NF, 0:NF].T.conj()
    glG[0, 0:NF,
        0:NF] = glR[0, 0:NF, 0:NF] @ SigG[Bmin[0]:Bmax[0] + 1, Bmin[0]:Bmax[0] + 1] @ glR[0, 0:NF, 0:NF].T.conj()
...
def step2_GF_rs(M, SigL, SigG, grR, grL, grG, GR, GRnn1, GL, GLnn1, GG, GGnn1, Bmin, Bmax):
    """
...
def step2_GF_ls(M, SigL, SigG, glR, glL, glG, GR, GRnn1, GL, GLnn1, GG, GGnn1, Bmin, Bmax):
    """
...
def rgf_GF_2S_V0(M, SigL, SigG, Bmin, Bmax):
    ...
    GR[EI, :NI, :NI] = np.linalg.inv(
        M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI]:Bmax[EI] + 1] -
        M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1] @ glR[EI - 1, :NM, :NM] @ M[Bmin[EI - 1]:Bmax[EI - 1] +
                                                                                            1, Bmin[EI]:Bmax[EI] + 1] -
        M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] + 1] @ grR[EI + 1, :NP, :NP] @ M[Bmin[EI + 1]:Bmax[EI + 1] +
                                                                                            1, Bmin[EI]:Bmax[EI] + 1])
    ...
    GL[EI, :NI, :NI] = GR[EI, :NI, :NI] @ (
        M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1] @ glL[EI - 1, :NM, :NM]
        @ M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1].T.conj() +
        M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] + 1] @ grL[EI + 1, :NP, :NP]
        @ M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] + 1].T.conj() +
        SigL[Bmin[EI]:Bmax[EI] + 1, Bmin[EI]:Bmax[EI] + 1] - (CL - CL.T.conj()) -
    ...
    GG[EI, :NI, :NI] = GR[EI, :NI, :NI] @ (
        M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1] @ glG[EI - 1, :NM, :NM]
        @ M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1].T.conj() +
        M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] + 1] @ grG[EI + 1, :NP, :NP]
        @ M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] + 1].T.conj() +
        SigG[Bmin[EI]:Bmax[EI] + 1, Bmin[EI]:Bmax[EI] + 1] - (CG - CG.T.conj()) -
...
def rgf_GF_2S_V1(M, SigL, SigG, Bmin, Bmax):
    ...
    step1_GF_rs(M[Bmin[EI]:, Bmin[EI]:], SigL[Bmin[EI]:, Bmin[EI]:], SigG[Bmin[EI]:, Bmin[EI]:], grR, grL, grG,
                Bmin[EI:] - Bmin[EI], Bmax[EI:] - Bmin[EI])
    # Valid?
    step1_GF_ls(M[:Bmin[EI], :Bmin[EI]], SigL[:Bmin[EI], :Bmin[EI]], SigG[:Bmin[EI], :Bmin[EI]], glR, glL, glG,
                Bmin[:EI], Bmax[:EI])
    ...
    GR[EI, :NI, :NI] = np.linalg.inv(M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI]:Bmax[EI] + 1] -
                                     M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1] @ glR[
                                         EI - 1, :NM, :NM] @ M[Bmin[EI - 1]:Bmax[EI - 1] + 1, Bmin[EI]:Bmax[EI] + 1] -
                                     M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] +
                                       1] @ grR[1, :NP, :NP] @ M[Bmin[EI + 1]:Bmax[EI + 1] + 1, Bmin[EI]:Bmax[EI] + 1])
    ...
    GL[EI, :NI, :NI] = GR[EI, :NI, :NI] @ (M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1] @ glL[
        EI - 1, :NM, :NM] @ M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1].T.conj() +
                                           M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] + 1] @ grL[1, :NP, :NP]
                                           @ M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] + 1].T.conj() +
                                           SigL[Bmin[EI]:Bmax[EI] + 1, Bmin[EI]:Bmax[EI] + 1] - (CL - CL.T.conj()) -
                                           (DL - DL.T.conj())) @ GR[EI, :NI, :NI].T.conj()
    ...
    GG[EI, :NI, :NI] = GR[EI, :NI, :NI] @ (M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1] @ glG[
        EI - 1, :NM, :NM] @ M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1].T.conj() +
                                           M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] + 1] @ grG[1, :NP, :NP]
                                           @ M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] + 1].T.conj() +
                                           SigG[Bmin[EI]:Bmax[EI] + 1, Bmin[EI]:Bmax[EI] + 1] - (CG - CG.T.conj()) -
                                           (DG - DG.T.conj())) @ GR[EI, :NI, :NI].T.conj()
    ...
    step2_GF_rs(M[Bmin[EI]:, Bmin[EI]:], SigL[Bmin[EI]:, Bmin[EI]:], SigG[Bmin[EI]:, Bmin[EI]:], grR, grL, grG, GR[EI:],
                GRnn1[EI:], GL[EI:], GLnn1[EI:], GG[EI:], GGnn1[EI:], Bmin[EI:] - Bmin[EI], Bmax[EI:] - Bmin[EI])

    step2_GF_ls(M[:Bmin[EI + 1], :Bmin[EI + 1]], SigL[:Bmin[EI + 1], :Bmin[EI + 1]], SigG[:Bmin[EI + 1], :Bmin[EI + 1]],
                glR, glL, glG, GR[:EI + 1], GRnn1[:EI + 1], GL[:EI + 1], GLnn1[:EI + 1], GG[:EI + 1], GGnn1[:EI + 1],
                Bmin[:EI + 1], Bmax[:EI + 1])
...
if __name__ == '__main__':
    ...
    if rank == 0:
        ...
        if size == 1:
            ...
            GR[EI, :NI, :NI] = np.linalg.inv(M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI]:Bmax[EI] + 1] -
                                             M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] +
                                               1] @ glR_ex @ M[Bmin[EI - 1]:Bmax[EI - 1] + 1, Bmin[EI]:Bmax[EI] + 1] -
                                             M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] + 1] @ grR[
                                                 1, :NP, :NP] @ M[Bmin[EI + 1]:Bmax[EI + 1] + 1, Bmin[EI]:Bmax[EI] + 1])
            ...
            GL[EI, :NI, :NI] = GR[EI, :NI, :NI] @ (
                M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1] @ glL_ex
                @ M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1].T.conj() +
                M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] + 1] @ grL[1, :NP, :NP]
                @ M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] + 1].T.conj() +
                SigL[Bmin[EI]:Bmax[EI] + 1, Bmin[EI]:Bmax[EI] + 1] - (CL - CL.T.conj()) -
            ...
            GG[EI, :NI, :NI] = GR[EI, :NI, :NI] @ (
                M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1] @ glG_ex
                @ M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1].T.conj() +
                M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] + 1] @ grG[1, :NP, :NP]
                @ M[Bmin[EI]:Bmax[EI] + 1, Bmin[EI + 1]:Bmax[EI + 1] + 1].T.conj() +
                SigG[Bmin[EI]:Bmax[EI] + 1, Bmin[EI]:Bmax[EI] + 1] - (CG - CG.T.conj()) -
            ...
            step2_GF_rs(M[Bmin[EI]:, Bmin[EI]:], SigL[Bmin[EI]:, Bmin[EI]:], SigG[Bmin[EI]:, Bmin[EI]:], grR, grL, grG,
                        GR[EI:], GRnn1[EI:], GL[EI:], GLnn1[EI:], GG[EI:], GGnn1[EI:], Bmin[EI:] - Bmin[EI],
                        Bmax[EI:] - Bmin[EI])
    ...
    if rank == 1:
        ...
        GR[EI - 1, :NI, :NI] = np.linalg.inv(
            M_part[Bmin[EI - 1]:Bmax[EI - 1] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1] -
            M_part[Bmin[EI - 1]:Bmax[EI - 1] + 1, Bmin[EI - 2]:Bmax[EI - 2] +
                   1] @ glR[EI - 2, :NM, :NM] @ M_part[Bmin[EI - 2]:Bmax[EI - 2] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1] -
            M_part[Bmin[EI - 1]:Bmax[EI - 1] + 1,
                   Bmin[EI]:Bmax[EI] + 1] @ grR_ex @ M_part[Bmin[EI]:Bmax[EI] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1])
        ...
        GL[EI - 1, :NI, :NI] = GR[EI - 1, :NI, :NI] @ (
            M_part[Bmin[EI - 1]:Bmax[EI - 1] + 1, Bmin[EI - 2]:Bmax[EI - 2] + 1] @ glL[EI - 2, :NM, :NM]
            @ M_part[Bmin[EI - 1]:Bmax[EI - 1] + 1, Bmin[EI - 2]:Bmax[EI - 2] + 1].T.conj() +
            M_part[Bmin[EI - 1]:Bmax[EI - 1] + 1, Bmin[EI]:Bmax[EI] + 1] @ grL_ex
            @ M_part[Bmin[EI - 1]:Bmax[EI - 1] + 1, Bmin[EI]:Bmax[EI] + 1].T.conj() +
            SigL_part[Bmin[EI - 1]:Bmax[EI - 1] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1] - (CL - CL.T.conj()) -
        ...
        GG[EI - 1, :NI, :NI] = GR[EI - 1, :NI, :NI] @ (
            M_part[Bmin[EI - 1]:Bmax[EI - 1] + 1, Bmin[EI - 2]:Bmax[EI - 2] + 1] @ glG[EI - 2, :NM, :NM]
            @ M_part[Bmin[EI - 1]:Bmax[EI - 1] + 1, Bmin[EI - 2]:Bmax[EI - 2] + 1].T.conj() +
            M_part[Bmin[EI - 1]:Bmax[EI - 1] + 1, Bmin[EI]:Bmax[EI] + 1] @ grG_ex
            @ M_part[Bmin[EI - 1]:Bmax[EI - 1] + 1, Bmin[EI]:Bmax[EI] + 1].T.conj() +
            SigG_part[Bmin[EI - 1]:Bmax[EI - 1] + 1, Bmin[EI - 1]:Bmax[EI - 1] + 1] - (CG - CG.T.conj()) -
        ...
        step2_GF_ls(M_part[:Bmin[EI], :Bmin[EI]], SigL_part[:Bmin[EI], :Bmin[EI]], SigG_part[:Bmin[EI], :Bmin[EI]], glR,
                    glL, glG, GR[:EI], GRnn1[:EI], GL[:EI], GLnn1[:EI], GG[:EI], GGnn1[:EI], Bmin[:EI], Bmax[:EI])
