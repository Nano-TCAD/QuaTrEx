...
def rgf(A_bloc_diag, A_bloc_upper, A_bloc_lower):
    ...
    for i in range(nblocks-2, -1, -1): 
        ...
        G_lower_1[i, ]             = -g_diag_left_to_right[i, ] @ A_bloc_lower[i, ] @ G_diag_left_to_right[i+1, ]
    ...
    for i in range(1, nblocks):
        ...
        G_upper_2[i-1, ]           = -g_diag_right_to_left[i, ] @ A_bloc_upper[i-1, ] @ G_diag_right_to_left[i-1, ]
