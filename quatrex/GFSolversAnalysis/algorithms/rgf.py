...
def rgf(A_bloc_diag, A_bloc_upper, A_bloc_lower):
    ...
    for i in range(nblocks-2, -1, -1): 
        ...
        G_upper[i, ]               = -g_diag_left_to_right[i, ] @ A_bloc_upper[i, ] @ G_diag_left_to_right[i+1, ]
        G_lower[i, ]               = -g_diag_left_to_right[i, ] @ A_bloc_lower[i, ] @ G_diag_left_to_right[i+1, ]
    ...
    #    G_lower[i-1, ]             = -g_diag_left_to_right[i-1, ] @ A_bloc_lower[i-1, ] @ G_diag_right_to_left[i-1, ]
    ...
    return G_diag_left_to_right, G_upper, G_lower
